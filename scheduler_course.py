...
🔹 ВАЖНО ПОМНИТЬ:
- Теги бывают парные: тегконтент/тег
    ...
    async def post_lesson(self):
        ...
        try:
            ...
            message_text = (
                f"📚 b{lesson['title']}/b\n\n"
                f"💡 bТеория:/b\n{lesson['text']}\n\n"
                f"📝 bДомашнее задание:/b\n{lesson['hw']}\n\n"
                f"✅ bСдаём ДЗ:/b ответом на это сообщение в этой же группе\n\n"
                f"🎯 bУровень:/b {lesson['type']}\n"
                f"📅 bДата:/b {datetime.now().strftime('%d.%m.%Y')}"
            )
