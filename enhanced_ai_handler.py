...
👇 Также можете воспользоваться кнопками ниже:""",
    ...
    def _build_personalized_prompt(
        ...
        # Добавляем инструкцию про упоминание Вадзима когда уместно
        vadzim_context = ""
        ...
        if any(word in message_lower_for_vadzim for word in ["telegram", "бот", "боты", "python", "javascript", "django", "react", "создател", "вадим", "vadzim"]):
            vadzim_context = " Если уместно, можешь упомянуть, что создатель бота Вадзим (vadzim.by, @vadzim_belarus) специализируется на Python, JavaScript и Telegram-ботах. Но делай это естественно, только когда это релевантно."
